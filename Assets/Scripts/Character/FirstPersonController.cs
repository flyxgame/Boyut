...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void GetInput(out float speed)
        {
            ...
            {
                m_Input.Normalize();
                //ÝKÝ HAREKTE TUÞUNA AYNI ANDA BASTIYSAK
            }
            ...
            if (m_IsWalking != waswalking && m_UseFovKick && m_CharacterController.velocity.sqrMagnitude > 0)
            {
                ...
                //KOÞMA TUÞUNA BASTIÐIMIZDA (SHIFT)
            }
        ...
        IEnumerator Crouch(bool isCrouch)
        {
            if (isCrouch)
            {
                while (m_CharacterController.height > 0.6)
                {
            ...
            {
                while (m_CharacterController.height < 1.2)
                {
                    m_CharacterController.height += 0.1f;
                    yield return new WaitForSeconds(0.1f);
                }
